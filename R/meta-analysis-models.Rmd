...
Lets now have a look at the Agrawal dataset, which is bigger. Here, we'll just use metafor for simplicity, but we can apply MCMCglmm to these down the road.
...
```
This matches, but the CI's don't.
